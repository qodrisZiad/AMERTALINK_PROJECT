...
class Cabang extends CI_Controller
{
	...
	private $table = "tm_branch";
	private $primary_key = "fc_branch";
	private $secondary_key = "fv_branch";
	private $kolom = array("fc_branch","fv_branch","fv_alamat","fc_telp","fc_status");
	...
	public function Simpan(){
		...
		$message = ""; 
			$data = array(
				'fc_branch' => $this->input->post('a1'),
				'fv_branch' => $this->input->post('a2'),
				'fv_alamat' => $this->input->post('a3'),
