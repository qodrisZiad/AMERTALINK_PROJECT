                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" id="formDetail" style="display: none;" method="post" enctype="multipart/form-data">
                     	...
                     	$data = array(
                     		...
                     		'b1' => array('name'=>'b1','label' => 'Properti','type' => 'text','class' => 'form-control','col' => 'col-sm-4'), 
                     		'b2' => array('name'=>'b2','label' => 'Aktif','type' => 'option','class' => 'form-control','option' => array('1'=>'Aktif','0'=>'Non Aktif'),'col' => 'col-sm-2')
                     	);
                     	buat_form($data);  
                     	?> 
                    </form>  
