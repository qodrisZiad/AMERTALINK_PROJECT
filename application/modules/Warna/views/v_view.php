                  ...
                  <div class="x_content">
                     ...
                     <form class="form-horizontal form-label-left" id="formAksi" style="display: none;" method="post">
                     	...
                     	$data = array(
                     		...
                     		'a1' => array('name'=>'a1','label' => 'Warna','type' => 'text','class' => 'form-control','col' => 'col-sm-4'),
                     		'a2' => array('name'=>'a2','label' => 'Kode Warna','type' => 'text','class' => 'form-control','col' => 'col-sm-4'),
            		...
            		table = $('#datatable').DataTable({
			        	...
			        	'columns'	:[
			        		...
			        		<?php if($delete=='Y' || $update =='Y'){ ?>,{'mRender': function ( data, type, row ) {
	                       		return "<?php if($update == 'Y'){?><button class='btn btn-danger' onclick=hapus('"+row['fc_warna']+"')><i class='fa fa-close'></i></button><?php } ?>&nbsp;<?php if($delete =='Y'){ ?><button class='btn btn-info' onclick=edit('"+row['fc_warna']+"')><i class='fa fa-pencil'></i></button><?php } ?>";
	                    		},width:130
                			} <?php  }else{ ?>
                				,{'mRender': function ( data, type, row ) {
