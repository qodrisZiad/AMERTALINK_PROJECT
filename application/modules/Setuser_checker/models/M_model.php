<?php defined('BASEPATH') OR exit('No direct script access allowed');
 ...
 class M_model extends CI_Model {
    ...
    */
     var $table = 'v_setChecker';
     var $column_order = array(null,'fc_userid','fv_nama','fc_nobpb','fc_stock','fv_stock'); //set column field database for datatable orderable
     var $column_search = array('fc_userid','fv_nama','fc_nobpb','fc_stock','fv_stock'); //set column field database for datatable searchable 
     var $order = array('fc_userid' => 'asc'); // default order 
     ...
     {     
        ...
        $this->db->where(array('fc_branch' => $this->session->userdata("branch")));
     ...
     {     
        ...
        {
            $this->db->where(array('fc_branch' => $this->input->post('f_branch')));
        } 
