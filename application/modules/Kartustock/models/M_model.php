<?php defined('BASEPATH') OR exit('No direct script access allowed');
 ...
 class M_model extends CI_Model {
    ...
    */
     ...
     var $column_order = array(null,'fd_tgl','fv_stock','fv_variant','fn_in','fn_out','fn_sisa','fc_referensi','fc_ket','fc_userid'); //set column field database for datatable orderable
     var $column_search = array('fd_tgl','fv_stock','fv_variant','fc_referensi','fc_ket','fc_userid'); //set column field database for datatable searchable 
